...
typedef unsigned LONG_LONG RB_ID;
...
typedef VALUE rb_gvar_getter_t(RB_ID id, void *data, struct rb_global_variable *gvar);
typedef void  rb_gvar_setter_t(VALUE val, RB_ID id, void *data, struct rb_global_variable *gvar);
typedef void  rb_gvar_marker_t(VALUE *var);

VALUE rb_gvar_undef_getter(RB_ID id, void *data, struct rb_global_variable *gvar);
void  rb_gvar_undef_setter(VALUE val, RB_ID id, void *data, struct rb_global_variable *gvar);
void  rb_gvar_undef_marker(VALUE *var);

VALUE rb_gvar_val_getter(RB_ID id, void *data, struct rb_global_variable *gvar);
void  rb_gvar_val_setter(VALUE val, RB_ID id, void *data, struct rb_global_variable *gvar);
void  rb_gvar_val_marker(VALUE *var);

VALUE rb_gvar_var_getter(RB_ID id, void *data, struct rb_global_variable *gvar);
void  rb_gvar_var_setter(VALUE val, RB_ID id, void *data, struct rb_global_variable *gvar);
void  rb_gvar_var_marker(VALUE *var);

void  rb_gvar_readonly_setter(VALUE val, RB_ID id, void *data, struct rb_global_variable *gvar);
...
RB_ID rb_intern(const char*);
RB_ID rb_intern2(const char*, long);
RB_ID rb_intern_str(VALUE str);
const char *rb_id2name(RB_ID);
RB_ID rb_check_id(volatile VALUE *);
RB_ID rb_to_id(VALUE);
VALUE rb_id2str(RB_ID);

#define CONST_ID_CACHE(result, str)			\
    {							\
	static RB_ID rb_intern_id_cache;			\
...
#define rb_intern(str) \
    (__builtin_constant_p(str) ? \
        __extension__ (CONST_ID_CACHE((RB_ID), (str))) : \
        rb_intern(str))
...
VALUE rb_funcall(VALUE, RB_ID, int, ...);
VALUE rb_funcallv(VALUE, RB_ID, int, const VALUE*);
VALUE rb_funcallv_public(VALUE, RB_ID, int, const VALUE*);
#define rb_funcall2 rb_funcallv
#define rb_funcall3 rb_funcallv_public
VALUE rb_funcall_passing_block(VALUE, RB_ID, int, const VALUE*);
VALUE rb_funcall_with_block(VALUE, RB_ID, int, const VALUE*, VALUE);
...
VALUE rb_block_call(VALUE,RB_ID,int,const VALUE*,rb_block_call_func_t,VALUE);
...
typedef void (*rb_event_hook_func_t)(rb_event_flag_t evflag, VALUE data, VALUE self, RB_ID mid, VALUE klass);
